...
--hl.monitor({ output = "", mode = "2560x1440@165", position = "0x0", scale = "1", })
...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(FFFFFFFF)",  --{ colors = {"rgba(33ccffee)", "rgba(00ff99ee)"}, angle = 45 },
...
-- Example special workspace (scr3ddatchpad)
...
hl.bind(mainMod .. "+ SHIFT + P", hl.dsp.exec_cmd("playerctl previous"))
...
hl.bind("F7", hl.dsp.exec_cmd("pamixer --default-source -t"))
